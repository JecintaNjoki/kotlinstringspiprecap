fun main() {
    ...
    println(personCredentials("Jecinta",21,"Nigeria"))
    println(classroom("Hopper lab"))
    name()
    allVowels()
...
//I am y years old and I am from z.” Where x, y, and z are the provided name, age, and country respectively. (3 points)
fun personCredentials(name:String,age:Int,country:String):String{
...
fun classroom(name:String):Int{

        return name.length

}

//3. Write a function that takes in a name and prints out “That’s me!” when your name is passed to it, otherwise,
